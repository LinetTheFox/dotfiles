...
static const char *fonts[]          = { 
		"DejaVu Sans:size=7:antialias=true",
		"MesloLGS NF:size=7:antialias=true",
	};
static const char dmenufont[]       = "DejaVu Sans:size=7:antialias=true";
//background color
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  col_cyan  },
        [SchemeStatus]  = { col_gray3, "#0A1145",  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
